...
public class PlatformGridView extends LinearLayout implements
    ...
    private static final String TAG = "OnekeyShare";
    // 每行显示的格数
    ...
    public void onClick(View v) {
        ...
        if (plat != null) {
            ...
            if (name.equals("WechatMoments"))//朋友圈
                reqData.put("title", reqData.get("text").toString());
            Log.d(TAG, "platform:" + name + "title:" + reqData.get("title").toString());
