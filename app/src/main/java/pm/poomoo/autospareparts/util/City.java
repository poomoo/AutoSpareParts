...
public class City {
	...
	private static String[] province = { "直辖市", "特别行政区", "黑龙江", "吉林", "辽宁", "内蒙古", "河北", "河南", "山东", "山西", "江苏", "安徽", "陕西", "宁夏", "甘肃", "青海", "湖北", "湖南",
			"浙江", "江西", "福建", "贵州", "四川", "广东", "广西", "云南", "海南 ", "新疆", "西藏", "台湾" };
	private static String[][] city = { { "北京", "上海", "天津", "重庆" }, { "香港", "澳门" },
			...
			{ "西安", "韩城", "安康", "汉中", "宝鸡", "咸阳", "榆林", "渭南", "商洛", "铜川", "延安" }, { "银川", "固原", "中卫", "石嘴山", "吴忠" },
			...
			{ "乌鲁木齐", "阿勒泰", "阿克苏", "昌吉", "哈密", "和田", "喀什", "克拉玛依", "石河子", "塔城", "库尔勒", "吐鲁番", "伊宁" }, { "拉萨", "阿里", "昌都", "那曲", "日喀则", "山南", "林芝" },
			{ "台北", "高雄" } };

//    private static String[] provinceTwo = { "直辖市", "特别行政区", "黑龙江", "吉林", "辽宁", "内蒙古", "河北", "河南", "山东", "山西", "江苏", "安徽", "陕西", "宁夏", "甘肃", "青海", "湖北", "湖南",
//            "浙江", "江西", "福建", "贵州", "四川", "广东", "广西", "云南", "海南 ", "新疆", "西藏", "台湾" };

//    public static String[] getProvinceTwo() {
//        return provinceTwo;
//    }
