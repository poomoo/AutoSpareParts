...
//    private AddMore addmore;
     ...
     * 加载是否完成
     */
    private boolean addIsComplete = true;
...
//            switch (event.getAction()) {
//                case MotionEvent.ACTION_UP:
//                    handler.sendMessage(handler.obtainMessage(touchEventId, listView));
//                    break;
//                default:
//                    break;
//            }
...
//                    }
//                    // else{
//                    // handler.sendMessage(handler.obtainMessage(touchEventId,
//                    // list));
//                    // }
//                } else {
//                    handler.sendMessage(handler.obtainMessage(touchEventId, list));
//                    lastY = list.getScrollY();
//                }
//            }
//        }
//    };
...
//     * @param add
//     */
//    public void setOnAddMore(AddMore add) {
//        addmore = add;
//    }
