package pm.poomoo.autospareparts.adapter;
...
import pm.poomoo.autospareparts.util.BitmapCache;
...
public class ImageBucketAdapter extends BaseAdapter {
    ...
    BitmapCache cache;
    pm.poomoo.autospareparts.util.BitmapCache.ImageCallback callback = new pm.poomoo.autospareparts.util.BitmapCache.ImageCallback() {
        @Override
